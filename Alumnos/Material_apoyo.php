            ...
            <div class="modal-content">
                ...
                <div class="table-responsive">
                                ...
                                ?>
                                    ...
                                    <td><?php  echo $row2['no_pag']?></td>
                                   
                                    <br>
                                    <td><?php  echo $row2['archivo']?></td>
                                    <hr>
            ...
            <div class="modal-content">
                ...
                <div class="table-responsive">
                                ...
                                ?>
                                    ...
                                    <td><?php  echo $row3['no_pag']?></td>
                                   
                                    <br>
                                    <td><?php  echo $row3['archivo']?></td>
                                    <hr>
            ...
            <div class="modal-content">
                ...
                <div class="table-responsive">
                                ...
                                ?>
                                    ...
                                    <td><?php  echo $row4['no_pag']?></td>
                                   
                                    <br>
                                    <td><?php  echo $row4['archivo']?></td>
                                    <hr>
            ...
            <div class="modal-content">
                ...
                <div class="table-responsive">
                                ...
                                ?>
                                    ...
                                    <td><?php  echo $row5['no_pag']?></td>
                                   
                                    <br>
                                    <td><?php  echo $row5['archivo']?></td>
                                    <hr>
            ...
            <div class="modal-content">
                ...
                <div class="table-responsive">
                                ...
                                ?>
                                    ...
                                    <td><?php  echo $row6['no_pag']?></td>
                                   
                                    <br>
                                    <td><?php  echo $row6['archivo']?></td>
                                    <hr>
