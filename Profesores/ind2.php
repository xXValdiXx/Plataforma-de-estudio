		...
		<div class="wrapp">
			...
			<div class="articulo">
				<article>
					...
					<p>Su accesibilidad es muy sencilla y te permitira mantener una constante visualización de las 
                    deficiencias de los alumnos en las diferentes materias.</p>
					<p>En esta sección usted como profesor tiene multiples opciones como incorporar cursos, 
                    dar referencias bibliograficas, apuntes, diseñar examenes diagnosticos y todo lo necesario para 
                    apoyar al alumnado de la carrera.</p>
				</article>
			</div>
